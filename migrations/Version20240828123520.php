 ...
 */
final class Version20240828123520 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FD04FE1E5 FOREIGN KEY (enclosure_id) REFERENCES enclosure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
